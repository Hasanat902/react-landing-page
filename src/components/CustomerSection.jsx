        ...
        <div className='primary-container'>
            ...
            <div className='flex justify-between items-center mb-16'>
                <div className='max-w-[34rem]'>
                    <h2 className='text-4xl font-bold'>The best startup companies build on here</h2>
                </div>
                                ...
                                <div className='relative aspect-video overflow-hidden rounded-lg'>
                                    <video
                                     ...
                                     <div className='absolute inset-0 p-8 flex flex-col'>
                                        <img src={customer.logo} alt="" className='h-12 w-auto mb-auto' />
                                        <div className='sm:grid grid-cols-2 hidden items-end gap-8 text-white'>
                                            ...
                                            <div>
                                                ...
                                                <div className='flex items-center justify-between'>
                                                    ...
                                                    <button onClick={togglePlayPause} className='p-2 hover:bg-white/20 rounded-fll transition-colors'>
                                                        {
